...
import bms.animations_android.databinding.ActivityTransition3Binding;
...
public class TransitionActivity3 extends BaseDetailActivity {
  ...
  private void bindData() {
    ActivityTransition3Binding binding = DataBindingUtil.setContentView(this, R.layout
        .activity_transition3);
