...
import bms.animations_android.databinding.ActivityTransition1Binding;
...
public class TransitionActivity1 extends BaseDetailActivity {
  ...
  private void bindData() {
    ActivityTransition1Binding binding = DataBindingUtil.setContentView(this, R.layout
        .activity_transition1);
